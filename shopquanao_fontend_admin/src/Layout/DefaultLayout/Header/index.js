   ...
   <div >
      ...
      <ul className="navbar-nav">
        <li className="nav-item">
          <a className="nav-link" data-widget="pushmenu" href="a" role="button"><i className="fas fa-bars"></i></a>
        </li>
      ...
      <ul className="navbar-nav ml-auto">
        ...
        <li className="nav-item dropdown">
          ...
          <div className="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <div className="dropdown-divider"></div>
            <a href="a" className="dropdown-item dropdown-footer">See All Messages</a>
          </div>
        </li>
        ...
        <li className="nav-item dropdown">
          ...
          <div className="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <div className="dropdown-divider"></div>
            <a href="a" className="dropdown-item dropdown-footer">See All Notifications</a>
          </div>
        </li>
        <li className="nav-item">
